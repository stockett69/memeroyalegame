...
// node_modules/@rainbow-me/rainbowkit/dist/wallets/walletConnectors/chunk-SEUOHRUB.js
var zerionWallet = ({
  projectId,
  walletConnectParameters
}) => {
  ...
  return {
    ...
    iconUrl: async () => (await import("./zerionWallet-CYFHB5PA-J7GD36HU.js")).default,
    iconAccent: "#2962ef",
...
// node_modules/@rainbow-me/rainbowkit/dist/wallets/walletConnectors/chunk-352AHZHI.js
var tokenPocketWallet = ({
  ...
  return {
    ...
    iconUrl: async () => (await import("./tokenPocketWallet-BVMBOYTC-ZJAN6TH4.js")).default,
...
// node_modules/@rainbow-me/rainbowkit/dist/wallets/walletConnectors/chunk-YOEP4QBW.js
var trustWallet = ({
  projectId,
  walletConnectParameters
}) => {
  ...
  return {
    ...
    iconUrl: async () => (await import("./trustWallet-E2GVGE4U-MZ4OIX5X.js")).default,
...
var walletConnectWallet = ({
  ...
  return {
    ...
    name: "WalletConnect",
    installed: void 0,
    iconUrl: async () => (await import("./walletConnectWallet-FNSU4KNU-6VHBF44Z.js")).default,
...
var uniswapWallet = ({
  ...
  id: "uniswap",
  name: "Uniswap Wallet",
  iconUrl: async () => (await import("./uniswapWallet-T26M44R7-YYXUJAEC.js")).default,
...
var wigwamWallet = () => {
  return {
    ...
    iconUrl: async () => (await import("./wigwamWallet-5GKUN7ZJ-X6KF7U3Y.js")).default,
    downloadUrls: {
...
var xdefiWallet = () => {
  return {
    ...
    iconUrl: async () => (await import("./xdefiWallet-ZA65GDWS-A4BMLXLI.js")).default,
    iconBackground: "#fff",
    downloadUrls: {
...
var zealWallet = ({
  ...
  return {
    ...
    name: "Zeal",
    rdns: "app.zeal",
    iconUrl: async () => (await import("./zealWallet-URNQ2AWF-I4JXJARB.js")).default,
    iconBackground: "#fff0",
    iconAccent: "#00FFFF",
    downloadUrls: {
...
var tokenaryWallet = () => ({
  id: "tokenary",
  name: "Tokenary",
  iconUrl: async () => (await import("./tokenaryWallet-Z2IGVXSA-MFV4ZA3G.js")).default,
...
var safeWallet = () => ({
  ...
  iconAccent: "#12ff80",
  iconBackground: "#fff",
  iconUrl: async () => (await import("./safeWallet-VUYZPLY4-2LWC7JZG.js")).default,
  installed: (
...
var safeheronWallet = () => ({
  ...
  iconUrl: async () => (await import("./safeheronWallet-6JG77AKC-7R7XKQMM.js")).default,
  iconBackground: "#fff",
  downloadUrls: {
...
var safepalWallet = ({
  ...
  return {
    id: "safepal",
    name: "SafePal Wallet",
    iconUrl: async () => (await import("./safepalWallet-KQJ4OCNH-HEJFKMI6.js")).default,
    // Note that we never resolve `installed` to `false` because the
...
var subWallet = ({
  ...
  return {
    ...
    name: "SubWallet",
    rdns: "app.subwallet",
    iconUrl: async () => (await import("./subWallet-LOZELSAO-DMCVGLVY.js")).default,
    iconBackground: "#fff",
...
var tahoWallet = () => {
  return {
    ...
    iconUrl: async () => (await import("./tahoWallet-L6KHUNKD-6H74QFT6.js")).default,
    downloadUrls: {
...
var talismanWallet = () => ({
  ...
  name: "Talisman",
  rdns: "xyz.talisman",
  iconUrl: async () => (await import("./talismanWallet-BLXUHONV-RKI6FONE.js")).default,
  iconBackground: "#fff",
  installed: hasInjectedProvider({
...
function seifWallet() {
  ...
  return {
    ...
    iconUrl: async () => (await import("./seifWallet-QATOS33A-XFFBHHVV.js")).default,
    iconBackground: "#fff",
    downloadUrls: {
...
var valoraWallet = ({
  ...
  id: "valora",
  name: "Valora",
  iconUrl: async () => (await import("./valoraWallet-RX3ONO47-RY43DMKK.js")).default,
  iconBackground: "#FFFFFF",
  downloadUrls: {
...
var omniWallet = ({
  ...
  id: "omni",
  name: "Omni",
  iconUrl: async () => (await import("./omniWallet-DEYUMT4A-3NBL3A7T.js")).default,
  iconBackground: "#000",
  downloadUrls: {
...
var phantomWallet = () => {
  return {
    ...
    name: "Phantom",
    rdns: "app.phantom",
    iconUrl: async () => (await import("./phantomWallet-IPGVKCAB-UMHPBA7Z.js")).default,
...
var oktoWallet = ({
  ...
  id: "Okto",
  name: "Okto",
  iconUrl: async () => (await import("./oktoWallet-GJFOPPEA-DI2QUFTY.js")).default,
  iconBackground: "#fff",
  downloadUrls: {
...
var paraSwapWallet = ({
  ...
  iconUrl: async () => (await import("./paraSwapWallet-TMV5MUEF-OESVOXRA.js")).default,
...
var rabbyWallet = () => ({
  id: "rabby",
  name: "Rabby Wallet",
  iconUrl: async () => (await import("./rabbyWallet-FLVUU35F-3YC5LMWL.js")).default,
  rdns: "io.rabby",
...
var ramperWallet = () => {
  ...
  return {
    id: "ramper",
    name: "Ramper Wallet",
    iconUrl: async () => (await import("./ramperWallet-AF5AKK2S-DKQUKTWE.js")).default,
...
var roninWallet = ({
  ...
  return {
    id: "ronin",
    name: "Ronin Wallet",
    iconUrl: async () => (await import("./roninWallet-SAB5ESVK-67I77MBF.js")).default,
    iconBackground: "#ffffff",
...
// node_modules/@rainbow-me/rainbowkit/dist/wallets/walletConnectors/chunk-OTMU7OP3.js
var rainbowWallet = ({
  projectId,
  walletConnectParameters
}) => {
  ...
  return {
    ...
    name: "Rainbow",
    rdns: "me.rainbow",
    iconUrl: async () => (await import("./rainbowWallet-2SR6TVBF-QREHPGHL.js")).default,
...
var ledgerWallet = ({
  ...
  iconAccent: "#000",
  name: "Ledger",
  iconUrl: async () => (await import("./ledgerWallet-KZKJ5Q2S-QRZ3FSJN.js")).default,
  downloadUrls: {
...
var magicEdenWallet = () => {
  return {
    ...
    iconUrl: async () => (await import("./magicEden-PKT2ZXEQ-O5XRGYOF.js")).default,
...
var krakenWallet = ({
  ...
  id: "kraken",
  name: "Kraken Wallet",
  iconUrl: async () => (await import("./krakenWallet-DAOXUKWO-C5K77ZVM.js")).default,
  iconBackground: "#FFD8EA",
  downloadUrls: {
...
// node_modules/@rainbow-me/rainbowkit/dist/wallets/walletConnectors/chunk-GSLOIIT7.js
...
var metaMaskWallet = ({
  ...
  return {
    ...
    name: "MetaMask",
    rdns: "io.metamask",
    iconUrl: async () => (await import("./metaMaskWallet-YFHEHW7V-QAWNSM5L.js")).default,
    iconAccent: "#f6851a",
    iconBackground: "#fff",
...
var nestWallet = () => ({
  ...
  name: "Nest",
  rdns: "xyz.nestwallet",
  iconUrl: async () => (await import("./nestWallet-BFZZZYLV-OYK2FRJ7.js")).default,
  iconBackground: "#fff0",
...
var oneKeyWallet = () => {
  return {
    ...
    iconAccent: "#00B812",
    iconBackground: "#fff",
    iconUrl: async () => (await import("./oneKeyWallet-4MM7G2SZ-FVMERL2M.js")).default,
...
var oneInchWallet = ({
  ...
  id: "1inch",
  name: "1inch Wallet",
  iconUrl: async () => (await import("./oneInchWallet-D7BQOLOO-U74OOTAH.js")).default,
  iconBackground: "#fff",
  downloadUrls: {
...
// node_modules/@rainbow-me/rainbowkit/dist/wallets/walletConnectors/chunk-XOT364TT.js
var okxWallet = ({
  projectId,
  walletConnectParameters
}) => {
  ...
  return {
    ...
    iconUrl: async () => (await import("./okxWallet-GJMKZIND-XAJO6PQ5.js")).default,
    iconAccent: "#000",
    iconBackground: "#000",
    downloadUrls: {
...
var imTokenWallet = ({
  ...
  id: "imToken",
  name: "imToken",
  iconUrl: async () => (await import("./imTokenWallet-N2MYFADO-KD3AXS6S.js")).default,
...
// node_modules/@rainbow-me/rainbowkit/dist/wallets/walletConnectors/chunk-MLOTBGVQ.js
...
var iopayWallet = ({
  ...
  id: "iopay",
  name: "ioPay Wallet",
  iconUrl: async () => (await import("./iopayWallet-IJHJ7NYT-KNVYQ4EV.js")).default,
  iconBackground: "#fff",
  downloadUrls: {
...
var injectedWallet = () => ({
  id: "injected",
  name: "Browser Wallet",
  iconUrl: async () => (await import("./injectedWallet-H7LYKTQS-YL3VGJJV.js")).default,
  iconBackground: "#fff",
  createConnector: getInjectedConnector({})
});

// node_modules/@rainbow-me/rainbowkit/dist/wallets/walletConnectors/chunk-YRL27PQX.js
var gateWallet = ({
  projectId,
  walletConnectParameters
}) => {
  ...
  return {
    ...
    name: "Gate Wallet",
    rdns: "io.gate.wallet",
    iconUrl: async () => (await import("./gateWallet-ZVEZILRP-W6M4UZUW.js")).default,
    iconAccent: "#fff",
    iconBackground: "#fff",
    downloadUrls: {
...
var kaikasWallet = ({
  ...
  return {
    id: "kaikas",
    name: "Kaikas Wallet",
    iconUrl: async () => (await import("./kaikasWallet-F6Z6IPWN-GAY3KXFP.js")).default,
...
var kresusWallet = ({
  ...
  id: "kresus-wallet",
  name: "Kresus Wallet",
  iconUrl: async () => (await import("./kresusWallet-AUJWLAOF-IYYIRRJ5.js")).default,
  iconBackground: "#fff",
  downloadUrls: {
...
var kaiaWallet = ({
  ...
  return {
    id: "kaia",
    name: "Kaia Wallet",
    iconUrl: async () => (await import("./kaiaWallet-5K6WZ3AH-ANAZH34F.js")).default,
...
var mewWallet = () => {
  return {
    id: "mew",
    name: "MEW wallet",
    iconUrl: async () => (await import("./mewWallet-6V4UZOQC-VSMFP7MV.js")).default,
    iconBackground: "#fff",
...
var coreWallet = ({
  ...
  return {
    ...
    iconUrl: async () => (await import("./coreWallet-52SXITOT-SKLY7J7H.js")).default,
...
var compassWallet = () => {
  ...
  return {
    ...
    iconUrl: async () => (await import("./compassWallet-3LBTWCKI-JQCWYRFO.js")).default,
    iconBackground: "#fff",
    downloadUrls: {
...
var dawnWallet = () => ({
  id: "dawn",
  name: "Dawn",
  iconUrl: async () => (await import("./dawnWallet-ONVAA3S4-NTVMRHLZ.js")).default,
...
var desigWallet = () => {
  return {
    id: "desig",
    name: "Desig Wallet",
    iconUrl: async () => (await import("./desigWallet-WJMSF3PS-OHOEXRXW.js")).default,
    iconBackground: "#ffffff",
...
var foxWallet = ({
  ...
  return {
    id: "foxwallet",
    name: "FoxWallet",
    iconUrl: async () => (await import("./foxWallet-5ESSNXJV-56ASGBQS.js")).default,
    iconBackground: "#fff",
    downloadUrls: {
...
var enkryptWallet = () => {
  return {
    ...
    iconUrl: async () => (await import("./enkryptWallet-FR4QCDFK-OEDYMEKQ.js")).default,
    iconBackground: "#FFFFFF",
    downloadUrls: {
...
var frameWallet = () => ({
  ...
  iconUrl: async () => (await import("./frameWallet-FDBUY4AA-VPXEO6HC.js")).default,
...
// node_modules/@rainbow-me/rainbowkit/dist/wallets/walletConnectors/chunk-TFBFKGDU.js
var frontierWallet = ({
  projectId,
  walletConnectParameters
}) => {
  ...
  return {
    ...
    iconUrl: async () => (await import("./frontierWallet-HNIG7QYQ-IAVXQYKK.js")).default,
...
// node_modules/@rainbow-me/rainbowkit/dist/wallets/walletConnectors/chunk-R73BQ3AR.js
var binanceWallet = ({
  projectId,
  walletConnectParameters
}) => {
  ...
  return {
    ...
    iconUrl: async () => (await import("./binanceWallet-BCWLBY3Q-LMA4425B.js")).default,
    iconBackground: "#000000",
...
var bitskiWallet = () => ({
  ...
  iconUrl: async () => (await import("./bitskiWallet-X5NWL5CE-SVFDULID.js")).default,
  iconBackground: "#fff",
  downloadUrls: {
...
var braveWallet = () => ({
  ...
  iconUrl: async () => (await import("./braveWallet-6QAF4GDN-6GDL47HI.js")).default,
  iconBackground: "#fff",
...
var clvWallet = ({
  ...
  return {
    id: "clv",
    name: "CLV",
    iconUrl: async () => (await import("./clvWallet-ZIMSRU5J-UXYXOEBF.js")).default,
    iconBackground: "#fff",
    iconAccent: "#BDFDE2",
...
var bloomWallet = ({
  ...
  iconBackground: "#000",
  iconAccent: "#000",
  iconUrl: async () => (await import("./bloomWallet-MXLAOWS6-6JTBMRLZ.js")).default,
  downloadUrls: {
...
var bybitWallet = ({
  ...
  return {
    ...
    name: "Bybit Wallet",
    rdns: "com.bybit",
    iconUrl: async () => (await import("./bybitWallet-GR4PFINZ-GZ7Y3FCC.js")).default,
...
var coin98Wallet = ({
  ...
  return {
    id: "coin98",
    name: "Coin98 Wallet",
    iconUrl: async () => (await import("./coin98Wallet-RFXRNVWP-32U6FPSG.js")).default,
...
var coinbaseWallet2 = ({ appName, appIcon }) => {
  ...
  return {
    ...
    iconUrl: async () => (await import("./coinbaseWallet-WWX6LF36-PAQDKGA2.js")).default,
    iconAccent: "#2c5ff6",
...
var argentWallet = ({
  ...
  id: "argent",
  name: "Argent",
  iconUrl: async () => (await import("./argentWallet-M6SBG4CU-BT7WM6XU.js")).default,
  iconBackground: "#fff",
  downloadUrls: {
...
var berasigWallet = ({
  ...
  return {
    id: "berasig",
    name: "BeraSig",
    iconUrl: async () => (await import("./berasigWallet-NNBFDHFK-SNFSA5FK.js")).default,
    iconBackground: "#ffffff",
...
// node_modules/@rainbow-me/rainbowkit/dist/wallets/walletConnectors/chunk-FJIJ2UR2.js
var backpackWallet = () => {
  return {
    id: "backpack",
    name: "Backpack",
    rdns: "app.backpack.mobile",
    iconUrl: async () => (await import("./backpackWallet-YIZS5YRE-CUDB7LWG.js")).default,
...
var bestWallet = ({
  ...
  id: "bestWallet",
  name: "Best Wallet",
  iconUrl: async () => (await import("./bestWallet-XRIABRUE-KBDKZCPW.js")).default,
...
// node_modules/@rainbow-me/rainbowkit/dist/wallets/walletConnectors/chunk-RICMZIKD.js
var bifrostWallet = ({
  projectId,
  walletConnectParameters
}) => {
  ...
  return {
    id: "bifrostWallet",
    name: "Bifrost Wallet",
    iconUrl: async () => (await import("./bifrostWallet-ORF3DABG-TRIN43GP.js")).default,
    iconBackground: "#fff",
...
// node_modules/@rainbow-me/rainbowkit/dist/wallets/walletConnectors/chunk-LLWGUVKX.js
var bitgetWallet = ({
  projectId,
  walletConnectParameters
}) => {
  ...
  return {
    ...
    iconUrl: async () => (await import("./bitgetWallet-CLYTW54T-GN7TYR64.js")).default,
    iconAccent: "#f6851a",
    iconBackground: "#fff",
...
var bitverseWallet = ({
  ...
  iconUrl: async () => (await import("./bitverseWallet-6SGDFATJ-HTEBUQEI.js")).default,
