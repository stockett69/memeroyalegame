...
import {
  ...
  withRetry,
  withTimeout
} from "./chunk-RWKOVJ7I.js";
import "./chunk-6DNN6TV7.js";
import {
  Field,
  FpInvertBatch,
  FpLegendre,
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createCoinbaseWalletSDK } = await import("./dist-XCTCYC7T.js");
    ...
    async getProvider() {
      ...
      if (!walletProvider) {
        const CoinbaseWalletSDK = await (async () => {
          const { default: SDK } = await import("./dist-GQXPPQPD.js");
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!isIframe)
        return;
      if (!provider_) {
        const { default: SDK } = await import("./esm-XQEEYJNE.js");
        ...
        const SafeAppProvider = await (async () => {
          const Provider = await import("./dist-VEROPJZK.js");
    ...
    async getProvider({ chainId } = {}) {
      ...
      async function initProvider() {
        ...
        if (!optionalChains.length)
          return;
        const { EthereumProvider } = await import("./index.es-F3HJXAD3.js");
...
var fetchTranslations = async (locale) => {
  switch (locale) {
    case "ar":
    case "ar-AR":
      return (await import("./ar_AR-ZRPPM56D-6T7G5OTD.js")).default;
    case "de":
    case "de-DE":
      return (await import("./de_DE-GYZFZXWH-AWEEW2JZ.js")).default;
    case "en":
    case "en-US":
      return (await import("./en_US-AV7YDYDW-UIXWXSDU.js")).default;
    case "es":
    case "es-419":
      return (await import("./es_419-OGVOQEFZ-3VTFNZ7P.js")).default;
    case "fr":
    case "fr-FR":
      return (await import("./fr_FR-Q5QBQBX2-RYA57DKK.js")).default;
    case "hi":
    case "hi-IN":
      return (await import("./hi_IN-7I7LRHGW-W2XODIPS.js")).default;
    case "id":
    case "id-ID":
      return (await import("./id_ID-ZMGZ2JFV-HUKZJ5XA.js")).default;
    case "ja":
    case "ja-JP":
      return (await import("./ja_JP-NYBCHQTZ-TXAWT366.js")).default;
    case "ko":
    case "ko-KR":
      return (await import("./ko_KR-67WE736M-TKMGAN3N.js")).default;
    case "ms":
    case "ms-MY":
      return (await import("./ms_MY-65AJIBUS-MODTYSVL.js")).default;
    case "pt":
    case "pt-BR":
      return (await import("./pt_BR-DMJANC65-23VGKORL.js")).default;
    case "ru":
    case "ru-RU":
      return (await import("./ru_RU-WER7RQ6A-GLTNVTTQ.js")).default;
    case "th":
    case "th-TH":
      return (await import("./th_TH-JOSHEZ6D-QJYV5G6B.js")).default;
    case "tr":
    case "tr-TR":
      return (await import("./tr_TR-EAMG2YPO-CH74V4JB.js")).default;
    case "ua":
    case "uk-UA":
      return (await import("./uk_UA-GO2TRVWA-K3SPMB6N.js")).default;
    case "vi":
    case "vi-VN":
      return (await import("./vi_VN-5HLLSOJA-GIJAWSOG.js")).default;
    case "zh":
    case "zh-CN":
    case "zh-Hans":
      return (await import("./zh_CN-THPIFVWJ-4RBZWDYI.js")).default;
    case "zh-HK":
      return (await import("./zh_HK-R7XP4TGF-ATBW3G6H.js")).default;
    case "zh-Hant":
    case "zh-TW":
      return (await import("./zh_TW-F5LD752V-DY3O24MI.js")).default;
    default:
      return (await import("./en_US-AV7YDYDW-UIXWXSDU.js")).default;
  }
};
...
var apeChainIcon = {
  ...
  iconUrl: async () => (await import("./apechain-COEQ5RUI-ZIYYFU32.js")).default
};
var arbitrumIcon = {
  iconBackground: "#96bedc",
  iconUrl: async () => (await import("./arbitrum-HW44W6XR-R4KYMQXZ.js")).default
};
var avalancheIcon = {
  iconBackground: "#e84141",
  iconUrl: async () => (await import("./avalanche-MXEFEDSW-3T732EIP.js")).default
};
var baseIcon = {
  iconBackground: "#0052ff",
  iconUrl: async () => (await import("./base-Z4LFBE5D-M4WTKLOD.js")).default
};
var berachainIcon = {
  iconBackground: "#814625",
  iconUrl: async () => (await import("./berachain-ZN3U5LDZ-KZV6CDJW.js")).default
};
var blastIcon = {
  iconBackground: "#000000",
  iconUrl: async () => (await import("./blast-46UQLYYY-VHZP67JA.js")).default
};
var bscIcon = {
  iconBackground: "#ebac0e",
  iconUrl: async () => (await import("./bsc-RVE67I5L-H5KTLFGZ.js")).default
};
var celoIcon = {
  iconBackground: "#FCFF52",
  iconUrl: async () => (await import("./celo-E6XU57FO-YB6S6YJE.js")).default
};
var cronosIcon = {
  iconBackground: "#002D74",
  iconUrl: async () => (await import("./cronos-ROYR77VZ-ED37A5MT.js")).default
};
var degenIcon = {
  iconBackground: "#A36EFD",
  iconUrl: async () => (await import("./degen-7ROC3GCY-AOPUXNC7.js")).default
};
var ethereumIcon = {
  iconBackground: "#484c50",
  iconUrl: async () => (await import("./ethereum-RFBAMUVK-GAQWZ3MW.js")).default
};
var flowIcon = {
  iconBackground: "transparent",
  iconUrl: async () => (await import("./flow-NBCRNYVF-HTI3LHLC.js")).default
};
var gnosisIcon = {
  iconBackground: "#04795c",
  iconUrl: async () => (await import("./gnosis-Y56LN66M-5EP65ENH.js")).default
};
var gravityIcon = {
  iconBackground: "#000000",
  iconUrl: async () => (await import("./gravity-LMEBVSFN-OL7JX7HW.js")).default
};
var hardhatIcon = {
  iconBackground: "#f9f7ec",
  iconUrl: async () => (await import("./hardhat-NEEC6JX7-63WJVZOI.js")).default
};
var hyperevmIcon = {
  iconBackground: "#000000",
  iconUrl: async () => (await import("./hyperevm-J6CONVCX-WA7RR25X.js")).default
};
var inkIcon = {
  iconBackground: "#7132F5",
  iconUrl: async () => (await import("./ink-4U4ZVNAB-2TOUKOEH.js")).default
};
var kaiaIcon = {
  iconBackground: "transparent",
  iconUrl: async () => (await import("./kaia-A33DVQBT-AHSMVDHH.js")).default
};
var lineaIcon = {
  iconBackground: "#ffffff",
  iconUrl: async () => (await import("./linea-IALBSJQC-AAI7Q2OJ.js")).default
};
var mantaIcon = {
  iconBackground: "#ffffff",
  iconUrl: async () => (await import("./manta-5V6W5D7G-ULD7OCGK.js")).default
};
var mantleIcon = {
  iconBackground: "#000000",
  iconUrl: async () => (await import("./mantle-KBL3OIYT-QKA2DC3D.js")).default
};
var optimismIcon = {
  iconBackground: "#ff5a57",
  iconUrl: async () => (await import("./optimism-YWJ3IQHA-6VFHMRLG.js")).default
};
var polygonIcon = {
  iconBackground: "#9f71ec",
  iconUrl: async () => (await import("./polygon-WWEUOMKW-NZQ7X4JQ.js")).default
};
var roninIcon = {
  iconBackground: "#1273EA",
  iconUrl: async () => (await import("./ronin-PNHX5V6H-SG6YU7X7.js")).default
};
var sankoIcon = {
  iconBackground: "#000000",
...
var scrollIcon = {
  ...
  iconUrl: async () => (await import("./scroll-MCKFTBRS-DPE5JUVL.js")).default
};
var unichainIcon = {
  iconBackground: "#F50DB4",
  iconUrl: async () => (await import("./unichain-OQ3BZUDH-Q2RJRA56.js")).default
};
var xdcIcon = {
  iconBackground: "#f9f7ec",
  iconUrl: async () => (await import("./xdc-X7V4QFNF-QAIJELED.js")).default
};
var zetachainIcon = {
  iconBackground: "#000000",
  iconUrl: async () => (await import("./zetachain-BMJKVYBN-BBOQQCVB.js")).default
};
var zkSyncIcon = {
  iconBackground: "#f9f7ec",
  iconUrl: async () => (await import("./zksync-UWUXFL74-VJ6SWP34.js")).default
};
var zoraIcon = {
  iconBackground: "#000000",
  iconUrl: async () => (await import("./zora-YZH32HP3-VO3M4FO6.js")).default
};
...
var src = async () => (await import("./assets-NU2OP443-6U634PUI.js")).default;
...
var src2 = async () => (await import("./login-CWDTIDNK-YAP3D3YM.js")).default;
...
var src3 = async () => (await import("./connect-MR6XDLIE-M3OLAQC2.js")).default;
...
var src4 = async () => (await import("./create-X4WFHLCW-5XDUJ7QF.js")).default;
...
var src5 = async () => (await import("./refresh-HJGJRASX-GYMQCSFH.js")).default;
...
var src6 = async () => (await import("./scan-DEOT2M37-CQXGEHG3.js")).default;
...
var getBrowserSrc = async () => {
  ...
  switch (browser) {
    case "Arc":
      return (await import("./Arc-R3PUWRPJ-362Q6QH6.js")).default;
    case "Brave":
      return (await import("./Brave-24BM36UM-7US6LBPH.js")).default;
    case "Chrome":
      return (await import("./Chrome-TLI42HDP-L7AWPN7C.js")).default;
    case "Edge":
      return (await import("./Edge-AZ34LAFM-GM6YGZWZ.js")).default;
    case "Firefox":
      return (await import("./Firefox-ZDK7RHKK-HB7CJMMO.js")).default;
    case "Opera":
      return (await import("./Opera-BKMCKUXC-TBF3SAHO.js")).default;
    case "Safari":
      return (await import("./Safari-PXQIVS6N-77RVNEQY.js")).default;
    default:
      return (await import("./Browser-4R4QKTV2-N6O6COA6.js")).default;
  }
};
...
var getPlatformSrc = async () => {
  ...
  switch (platform) {
    case "Windows":
      return (await import("./Windows-GTAT3OTE-THRNOLX4.js")).default;
    case "macOS":
      return (await import("./Macos-5QL4JBJE-4EY4DOFT.js")).default;
    case "Linux":
      return (await import("./Linux-VYP66PDO-3FDPKPSC.js")).default;
    default:
      return (await import("./Linux-VYP66PDO-3FDPKPSC.js")).default;
  }
};
...
var coinbaseWallet2 = ({ appName, appIcon }) => {
  ...
  return {
    ...
    shortName: "Coinbase",
    rdns: "com.coinbase.wallet",
    iconUrl: async () => (await import("./coinbaseWallet-WWX6LF36-IOOCLMGW.js")).default,
    iconAccent: "#2c5ff6",
...
var metaMaskWallet = ({
  ...
  return {
    ...
    name: "MetaMask",
    rdns: "io.metamask",
    iconUrl: async () => (await import("./metaMaskWallet-YFHEHW7V-W7E7W4ZR.js")).default,
    iconAccent: "#f6851a",
    iconBackground: "#fff",
...
var rainbowWallet = ({
  ...
  return {
    ...
    name: "Rainbow",
    rdns: "me.rainbow",
    iconUrl: async () => (await import("./rainbowWallet-2SR6TVBF-KMAFURFX.js")).default,
...
var safeWallet = () => ({
  ...
  iconAccent: "#12ff80",
  iconBackground: "#fff",
  iconUrl: async () => (await import("./safeWallet-VUYZPLY4-CPC75WU6.js")).default,
  installed: (
...
var walletConnectWallet = ({
  ...
  return {
    ...
    name: "WalletConnect",
    installed: void 0,
    iconUrl: async () => (await import("./walletConnectWallet-FNSU4KNU-5M2CNUFM.js")).default,
