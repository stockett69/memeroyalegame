...
var zerionWallet = ({
  ...
  return {
    ...
    iconUrl: async () => (await import("./zerionWallet-CYFHB5PA-BONRODPT.js")).default,
    iconAccent: "#2962ef",
...
var tokenPocketWallet = ({
  ...
  return {
    ...
    iconUrl: async () => (await import("./tokenPocketWallet-BVMBOYTC-DVHZ27MS.js")).default,
...
var trustWallet = ({
  ...
  return {
    ...
    iconUrl: async () => (await import("./trustWallet-E2GVGE4U-X3WOKHKR.js")).default,
...
var walletConnectWallet = ({
  ...
  return {
    ...
    name: "WalletConnect",
    installed: void 0,
    iconUrl: async () => (await import("./walletConnectWallet-FNSU4KNU-NT5ESDYB.js")).default,
...
var uniswapWallet = ({
  ...
  id: "uniswap",
  name: "Uniswap Wallet",
  iconUrl: async () => (await import("./uniswapWallet-T26M44R7-5Q4XLBDN.js")).default,
...
var wigwamWallet = () => {
  return {
    ...
    iconUrl: async () => (await import("./wigwamWallet-5GKUN7ZJ-XPNPWBLG.js")).default,
    downloadUrls: {
...
var xdefiWallet = () => {
  return {
    ...
    iconUrl: async () => (await import("./xdefiWallet-ZA65GDWS-GWLAXMIC.js")).default,
    iconBackground: "#fff",
    downloadUrls: {
...
var zealWallet = ({
  ...
  return {
    ...
    name: "Zeal",
    rdns: "app.zeal",
    iconUrl: async () => (await import("./zealWallet-URNQ2AWF-PJHUWU3V.js")).default,
    iconBackground: "#fff0",
    iconAccent: "#00FFFF",
    downloadUrls: {
...
var tokenaryWallet = () => ({
  id: "tokenary",
  name: "Tokenary",
  iconUrl: async () => (await import("./tokenaryWallet-Z2IGVXSA-BGOACUFG.js")).default,
...
var safeWallet = () => ({
  ...
  iconAccent: "#12ff80",
  iconBackground: "#fff",
  iconUrl: async () => (await import("./safeWallet-VUYZPLY4-FA5PNIIT.js")).default,
  installed: (
...
var safeheronWallet = () => ({
  ...
  iconUrl: async () => (await import("./safeheronWallet-6JG77AKC-DWLGIM34.js")).default,
  iconBackground: "#fff",
  downloadUrls: {
...
var safepalWallet = ({
  ...
  return {
    id: "safepal",
    name: "SafePal Wallet",
    iconUrl: async () => (await import("./safepalWallet-KQJ4OCNH-QNWZCYDQ.js")).default,
    // Note that we never resolve `installed` to `false` because the
...
var subWallet = ({
  ...
  return {
    ...
    name: "SubWallet",
    rdns: "app.subwallet",
    iconUrl: async () => (await import("./subWallet-LOZELSAO-HHSHJINC.js")).default,
    iconBackground: "#fff",
...
var tahoWallet = () => {
  return {
    ...
    iconUrl: async () => (await import("./tahoWallet-L6KHUNKD-ISAHGZS6.js")).default,
    downloadUrls: {
...
var talismanWallet = () => ({
  ...
  name: "Talisman",
  rdns: "xyz.talisman",
  iconUrl: async () => (await import("./talismanWallet-BLXUHONV-XY7TR44D.js")).default,
  iconBackground: "#fff",
  installed: hasInjectedProvider({
...
function seifWallet() {
  ...
  return {
    ...
    iconUrl: async () => (await import("./seifWallet-QATOS33A-N4MNQ6K5.js")).default,
    iconBackground: "#fff",
    downloadUrls: {
...
var valoraWallet = ({
  ...
  id: "valora",
  name: "Valora",
  iconUrl: async () => (await import("./valoraWallet-RX3ONO47-RHSFEOBP.js")).default,
  iconBackground: "#FFFFFF",
  downloadUrls: {
...
var omniWallet = ({
  ...
  id: "omni",
  name: "Omni",
  iconUrl: async () => (await import("./omniWallet-DEYUMT4A-5WBWD7VW.js")).default,
  iconBackground: "#000",
  downloadUrls: {
...
var phantomWallet = () => {
  return {
    ...
    name: "Phantom",
    rdns: "app.phantom",
    iconUrl: async () => (await import("./phantomWallet-IPGVKCAB-3RZ6SUN6.js")).default,
...
var oktoWallet = ({
  ...
  id: "Okto",
  name: "Okto",
  iconUrl: async () => (await import("./oktoWallet-GJFOPPEA-Q7WT74HT.js")).default,
  iconBackground: "#fff",
  downloadUrls: {
...
var paraSwapWallet = ({
  ...
  iconUrl: async () => (await import("./paraSwapWallet-TMV5MUEF-QQESJKGU.js")).default,
...
var rabbyWallet = () => ({
  id: "rabby",
  name: "Rabby Wallet",
  iconUrl: async () => (await import("./rabbyWallet-FLVUU35F-XVL4YVPY.js")).default,
  rdns: "io.rabby",
...
var ramperWallet = () => {
  ...
  return {
    id: "ramper",
    name: "Ramper Wallet",
    iconUrl: async () => (await import("./ramperWallet-AF5AKK2S-2NU54JPY.js")).default,
...
var roninWallet = ({
  ...
  return {
    id: "ronin",
    name: "Ronin Wallet",
    iconUrl: async () => (await import("./roninWallet-SAB5ESVK-MPZPROMK.js")).default,
    iconBackground: "#ffffff",
...
var rainbowWallet = ({
  ...
  return {
    ...
    name: "Rainbow",
    rdns: "me.rainbow",
    iconUrl: async () => (await import("./rainbowWallet-2SR6TVBF-DSPE34J4.js")).default,
...
var ledgerWallet = ({
  ...
  iconAccent: "#000",
  name: "Ledger",
  iconUrl: async () => (await import("./ledgerWallet-KZKJ5Q2S-6MHB4VKG.js")).default,
  downloadUrls: {
...
var magicEdenWallet = () => {
  return {
    ...
    iconUrl: async () => (await import("./magicEden-PKT2ZXEQ-ETQDAFIT.js")).default,
...
var krakenWallet = ({
  ...
  id: "kraken",
  name: "Kraken Wallet",
  iconUrl: async () => (await import("./krakenWallet-DAOXUKWO-SU6FIP6F.js")).default,
  iconBackground: "#FFD8EA",
  downloadUrls: {
...
var metaMaskWallet = ({
  ...
  return {
    ...
    name: "MetaMask",
    rdns: "io.metamask",
    iconUrl: async () => (await import("./metaMaskWallet-YFHEHW7V-ZBR3THJL.js")).default,
    iconAccent: "#f6851a",
    iconBackground: "#fff",
...
var nestWallet = () => ({
  ...
  name: "Nest",
  rdns: "xyz.nestwallet",
  iconUrl: async () => (await import("./nestWallet-BFZZZYLV-ZL3PIVH5.js")).default,
  iconBackground: "#fff0",
...
var oneKeyWallet = () => {
  return {
    ...
    iconAccent: "#00B812",
    iconBackground: "#fff",
    iconUrl: async () => (await import("./oneKeyWallet-4MM7G2SZ-D6DJ324V.js")).default,
...
var oneInchWallet = ({
  ...
  id: "1inch",
  name: "1inch Wallet",
  iconUrl: async () => (await import("./oneInchWallet-D7BQOLOO-LZ226ZC7.js")).default,
  iconBackground: "#fff",
  downloadUrls: {
...
var okxWallet = ({
  ...
  return {
    ...
    iconUrl: async () => (await import("./okxWallet-GJMKZIND-VM6I4R7V.js")).default,
    iconAccent: "#000",
    iconBackground: "#000",
    downloadUrls: {
...
var imTokenWallet = ({
  ...
  id: "imToken",
  name: "imToken",
  iconUrl: async () => (await import("./imTokenWallet-N2MYFADO-2E54WX2S.js")).default,
...
var iopayWallet = ({
  ...
  id: "iopay",
  name: "ioPay Wallet",
  iconUrl: async () => (await import("./iopayWallet-IJHJ7NYT-X7CS62VN.js")).default,
  iconBackground: "#fff",
  downloadUrls: {
...
var injectedWallet = () => ({
  id: "injected",
  name: "Browser Wallet",
  iconUrl: async () => (await import("./injectedWallet-H7LYKTQS-K7FGJQHB.js")).default,
  iconBackground: "#fff",
  createConnector: getInjectedConnector({})
});
...
var gateWallet = ({
  ...
  return {
    ...
    name: "Gate Wallet",
    rdns: "io.gate.wallet",
    iconUrl: async () => (await import("./gateWallet-ZVEZILRP-P6P6B7QX.js")).default,
    iconAccent: "#fff",
    iconBackground: "#fff",
    downloadUrls: {
...
var kaikasWallet = ({
  ...
  return {
    id: "kaikas",
    name: "Kaikas Wallet",
    iconUrl: async () => (await import("./kaikasWallet-F6Z6IPWN-Z3QA2PCZ.js")).default,
...
var kresusWallet = ({
  ...
  id: "kresus-wallet",
  name: "Kresus Wallet",
  iconUrl: async () => (await import("./kresusWallet-AUJWLAOF-QPRCBEIB.js")).default,
  iconBackground: "#fff",
  downloadUrls: {
...
var kaiaWallet = ({
  ...
  return {
    id: "kaia",
    name: "Kaia Wallet",
    iconUrl: async () => (await import("./kaiaWallet-5K6WZ3AH-EU4CIFW5.js")).default,
...
var mewWallet = () => {
  return {
    id: "mew",
    name: "MEW wallet",
    iconUrl: async () => (await import("./mewWallet-6V4UZOQC-2ICPERWA.js")).default,
    iconBackground: "#fff",
...
var coreWallet = ({
  ...
  return {
    ...
    iconUrl: async () => (await import("./coreWallet-52SXITOT-SUU6SWPT.js")).default,
...
var compassWallet = () => {
  ...
  return {
    ...
    iconUrl: async () => (await import("./compassWallet-3LBTWCKI-T7XRDDSB.js")).default,
    iconBackground: "#fff",
    downloadUrls: {
...
var dawnWallet = () => ({
  id: "dawn",
  name: "Dawn",
  iconUrl: async () => (await import("./dawnWallet-ONVAA3S4-ZJYALVN3.js")).default,
...
var desigWallet = () => {
  return {
    id: "desig",
    name: "Desig Wallet",
    iconUrl: async () => (await import("./desigWallet-WJMSF3PS-XCOQPJX6.js")).default,
    iconBackground: "#ffffff",
...
var foxWallet = ({
  ...
  return {
    id: "foxwallet",
    name: "FoxWallet",
    iconUrl: async () => (await import("./foxWallet-5ESSNXJV-ELW2IMFB.js")).default,
    iconBackground: "#fff",
    downloadUrls: {
...
var enkryptWallet = () => {
  return {
    ...
    iconUrl: async () => (await import("./enkryptWallet-FR4QCDFK-QAUZWBZT.js")).default,
    iconBackground: "#FFFFFF",
    downloadUrls: {
...
var frameWallet = () => ({
  ...
  iconUrl: async () => (await import("./frameWallet-FDBUY4AA-MXKRJ6RI.js")).default,
...
var frontierWallet = ({
  ...
  return {
    ...
    iconUrl: async () => (await import("./frontierWallet-HNIG7QYQ-VWGGHNEX.js")).default,
...
var binanceWallet = ({
  ...
  return {
    ...
    iconUrl: async () => (await import("./binanceWallet-BCWLBY3Q-7MQPQY3F.js")).default,
    iconBackground: "#000000",
...
var bitskiWallet = () => ({
  ...
  iconUrl: async () => (await import("./bitskiWallet-X5NWL5CE-QUND2XYD.js")).default,
  iconBackground: "#fff",
  downloadUrls: {
...
var braveWallet = () => ({
  ...
  iconUrl: async () => (await import("./braveWallet-6QAF4GDN-CRMB4GB2.js")).default,
  iconBackground: "#fff",
...
var clvWallet = ({
  ...
  return {
    id: "clv",
    name: "CLV",
    iconUrl: async () => (await import("./clvWallet-ZIMSRU5J-2C4OY7NB.js")).default,
    iconBackground: "#fff",
    iconAccent: "#BDFDE2",
...
var bloomWallet = ({
  ...
  iconBackground: "#000",
  iconAccent: "#000",
  iconUrl: async () => (await import("./bloomWallet-MXLAOWS6-Y5CP5HT4.js")).default,
  downloadUrls: {
...
var bybitWallet = ({
  ...
  return {
    ...
    name: "Bybit Wallet",
    rdns: "com.bybit",
    iconUrl: async () => (await import("./bybitWallet-GR4PFINZ-XJCIT3XA.js")).default,
...
var coin98Wallet = ({
  ...
  return {
    id: "coin98",
    name: "Coin98 Wallet",
    iconUrl: async () => (await import("./coin98Wallet-RFXRNVWP-R4ACMR3C.js")).default,
...
var coinbaseWallet2 = ({ appName, appIcon }) => {
  ...
  return {
    ...
    iconUrl: async () => (await import("./coinbaseWallet-WWX6LF36-NU3IG53P.js")).default,
    iconAccent: "#2c5ff6",
...
var argentWallet = ({
  ...
  id: "argent",
  name: "Argent",
  iconUrl: async () => (await import("./argentWallet-M6SBG4CU-YUSD7A5R.js")).default,
  iconBackground: "#fff",
  downloadUrls: {
...
var berasigWallet = ({
  ...
  return {
    id: "berasig",
    name: "BeraSig",
    iconUrl: async () => (await import("./berasigWallet-NNBFDHFK-4D5EUKF6.js")).default,
    iconBackground: "#ffffff",
...
var backpackWallet = () => {
  return {
    ...
    iconUrl: async () => (await import("./backpackWallet-YIZS5YRE-DZEIGS67.js")).default,
...
var bestWallet = ({
  ...
  id: "bestWallet",
  name: "Best Wallet",
  iconUrl: async () => (await import("./bestWallet-XRIABRUE-Z6FYOD63.js")).default,
...
var bifrostWallet = ({
  ...
  return {
    id: "bifrostWallet",
    name: "Bifrost Wallet",
    iconUrl: async () => (await import("./bifrostWallet-ORF3DABG-JZ3ZKCOC.js")).default,
    iconBackground: "#fff",
...
var bitgetWallet = ({
  ...
  return {
    ...
    iconUrl: async () => (await import("./bitgetWallet-CLYTW54T-AMAI7NVX.js")).default,
    iconAccent: "#f6851a",
    iconBackground: "#fff",
...
var bitverseWallet = ({
  ...
  iconUrl: async () => (await import("./bitverseWallet-6SGDFATJ-6KTJMAMI.js")).default,
